 ...
 */
void
luaA_button_array_set(lua_State *L, int oidx, int idx, std::vector<button_t*> *buttons)
{
 ...
 */
int
luaA_button_array_get(lua_State *L, int oidx, const std::vector<button_t*>& buttons)
{
